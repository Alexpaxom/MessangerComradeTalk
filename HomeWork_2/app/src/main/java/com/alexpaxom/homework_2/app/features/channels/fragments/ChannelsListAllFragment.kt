...
class ChannelsListAllFragment: ChannelsListFragment() {
    @Inject
    lateinit var daggerPresenter: Provider<ChannelsListAllPresenter>
    ...
    companion object {
        ...
        const val FRAGMENT_ID = "com.alexpaxom.CHANNELS_LIST_ALL_FRAGMENT_ID"

        @JvmStatic
        fun newInstance(
            ownerUserId: Int
        ) = ChannelsListAllFragment().apply {
